...
# preprocessing/tabular/transformers/sqrt.py
...
class SqrtTransformer(BasePreprocessor):
    """Square root transformation sqrt(x + shift). Shift is computed during
    fit and reused identically during transform (see LogTransformer)."""
